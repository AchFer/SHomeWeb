      ...
      <nav class="navbar navbar-inverse">
		...
		<div id="page-wrapper">
			...
			<div class="main-page">
				...
				<div class="row">
					 <form class="login-form" method="post" action='?core=node&action=add_node' enctype="multipart/form-data">
					...
					<div class="form-body" data-example-id="simple-form-inline">
                            ...
                            <div class="form-group">
									...
									<div class="col-sm-8">
										...
										<select multiple="" class="form-control1" name="user_id">
										 <?php 
						    ...
						    {   ?>
								...
								<div class="form-group"> 
							    <label for="exampleInputName2">Name of the node?</label> <input type="text" class="form-control" name="NomNoeud" > 
							</div> 
							    ...
							    <label for="exampleInputName2">Image?</label> <input type="file" class="form-control" name="image" > 
									  ...
									  <input class="btn btn-primary btn-lg btn-block" type="submit"  value="add node"></input> 
