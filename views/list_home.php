					...
					<div class="bs-example widget-shadow" data-example-id="contextual-table"> 
						...
						<table class="table">
						    ...
						    {   ?>
						        ...
						        <td><img src="uploads/<?php echo $maison->getImage(); ?>" width="75px" height="80px"></td>
						        <td><?php echo $maison->getAdresse(); ?></td>
						        <td>
						        <a class="btn btn-danger" href="?core=maison&action=delete&id_maison=<?php echo $maison->getId(); ?>">  delete </a>
                                <a class="btn btn-primary" href="?core=maison&action=page_update_home&id=<?php echo $maison->getId(); ?>"> Update </a>
                                
                                <a class = "btn btn-info " href="?core=maison&action=page_add_node&id_maison=<?php echo $maison->getId(); ?>"> add node</a>
                                </td>
