					...
					<div class="bs-example widget-shadow" data-example-id="contextual-table"> 
						...
						<table class="table">
						    ...
						    {   ?>
						        ...
						        <td><img src="uploads/<?php echo $user->getImage(); ?>" width="75px" height="80px"></td>
						        <td><?php echo $user->getNom(); ?></td>
						        <td><?php echo $user->getPrenom(); ?></td>
						        <td><?php echo $user->getEmail(); ?></td>
						        
						        <td>
						        <a class = "btn btn-warning" href="?core=maison&action=add_maison_page&id=<?php echo $user->getId(); ?>"> add Home</a>
						        <a class="btn btn-danger" href="?core=maison&action=delete_user&id=<?php echo $user->getId(); ?>">  delete </a>
                                <a class="btn btn-primary" href="?core=maison&action=update_user_page&id=<?php echo $user->getId(); ?>"> Update </a></td>
						        </tr> 
						         <?php } ?>
						    </tbody>
				        </table> 
