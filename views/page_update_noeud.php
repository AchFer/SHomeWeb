      ...
      <nav class="navbar navbar-inverse">
		...
		<div id="page-wrapper">
			...
			<div class="main-page">
				...
				<div class="row">
					 <form class="login-form" method="post" action='?core=node&action=updating_node' enctype="multipart/form-data">
					...
					<div class="form-two widget-shadow">
						<div class="form-title">
						    ...
						    {   ?>
						<h4><?php echo $noeud->getNomNoeud();?></h4>
						<input type="hidden" name='noeud_id' value= "<?php echo $noeud->getId();?>" >
					...
					<div class="form-body" data-example-id="simple-form-inline">
						    ...
						    {   ?>
							    ...
							    <label for="exampleInputName2">Name of the node?</label> <input type="text" class="form-control" name="NomNoeud" value="<?php echo $noeud->getNomNoeud(); ?>" > 
							</div> 
							

								<div class="form-group"> 
							    <label for="exampleInputName2">Image?</label> <input type="file" class="form-control" name="image" value="<?php echo $noeud->getImage(); ?>"> 
							</div>
