      ...
      <nav class="navbar navbar-inverse">
		...
		<div id="page-wrapper">
			...
			<div class="main-page">
				...
				<div class="row">
					 <form class="login-form" method="post" action='?core=node&action=add_capteur' enctype="multipart/form-data">
					...
					<div class="form-two widget-shadow">
						<div class="form-title">
						 ...
						 <?php 
						    ...
						    {   ?>
							<h3>Add Sensor for node :</h3><h4 > <?php echo $result->getNomNoeud(); ?></h4>
					...
					<div class="form-body" data-example-id="simple-form-inline">
							...
							<div class="form-group"> 
							    <label for="exampleInputName2">Sensor name</label> <input type="text" class="form-control" name="nomCapteur" placeholder="Exemple:gaz_cuisine"> 
							</div> 
							
<div class="form-group"> 
							    <label for="exampleInputName2">Sensor Reference</label> <input type="text" class="form-control" name="reference" placeholder="MQ-5"> 
							</div> 
									  ...
									  <input class="btn btn-primary btn-lg btn-block" type="submit"  value="add sensor"></input> 
