					...
					<div class="bs-example widget-shadow" data-example-id="contextual-table"> 
						...
						<table class="table">
						    ...
						    {   ?>
						        ...
						        <td><?php echo $Reclamation->getNom_rec(); ?></td>
						        <td><?php echo $Reclamation->getDescription(); ?></td>
						          
						        
						         <td>
						          <?php   $user_id=$Reclamation->getUtilisateur_id();
						        $us = Utilisateur::chercher_nom_user($user_id);
						         foreach($us as $u)
   {
   echo $u->getNom();
   }
						        ...
						        <td>
						        <a class="btn btn-danger" href="?core=node&action=reclamation_supprimer&idRec=<?php echo $Reclamation->getIdRec(); ?>">  delete  </a>
                                  <a class="btn btn-primary" href="?core=maison&action=send_mail&idUser=<?php echo $Reclamation->getUtilisateur_id(); ?>"> check mail  </a>
