      ...
      <nav class="navbar navbar-inverse">
		...
		<div id="page-wrapper">
			...
			<div class="main-page">
				...
				<div class="row">
					 <form class="login-form" method="post" action='?core=maison&action=update_user' enctype="multipart/form-data">
					...
					<div class="form-two widget-shadow">
						<div class="form-title">
						    ...
						    {   ?>
							<h3>Update user :</h3><h4 > <?php echo $user->getNom(); ?></h4>
					...
					<div class="form-body" data-example-id="simple-form-inline">
						...
						<div class="form-inline">
							...
							&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp 
							     <label for="exampleInputName2">First Name</label> <input type="text" class="form-control" name="nom" value="<?php echo $user->getNom(); ?>"> 
							</div>
							
							<div class="form-group"> 
							    <label for="exampleInputName2">Last Name</label> <input type="text" class="form-control" name="prenom" value="<?php echo $user->getPrenom(); ?>"> 
							</div> 
								<div class="form-group"> 
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<div class="input-group">							
												...
												<input type="text" name="Email" class="form-control1" value="<?php echo $user->getEmail(); ?>">
											</div>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-8">
											<div class="input-group">
												...
												<input type="text" class="form-control1" name="password" value="<?php echo $user->getPassword(); ?>">
											</div>
										</div>
 <?php } ?>
									</div>
								&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp 
									  ...
									  <input class="btn btn-primary btn-lg btn-block" type="submit"  value="finish updating"></input> 
