      ...
      <nav class="navbar navbar-inverse">
		...
		<div id="page-wrapper">
			...
			<div class="main-page">
				...
				<div class="row">
					 <form class="login-form" method="post" action='?core=maison&action=update_maison' enctype="multipart/form-data">
					...
					<div class="form-two widget-shadow">
						<div class="form-title">
						    ...
						    {   ?>
							<h3>Update Home :</h3><h4 > <?php echo $home->getAdresse(); ?></h4>
							<input type="hidden" name='home_id' value= "<?php echo $home->getId();?>" >
						</div>
					...
					<div class="form-body" data-example-id="simple-form-inline">
							...
							<div class="form-group"> 
							    <label for="exampleInputName2">Adress</label> <input type="text" class="form-control" name="adresse" value="<?php echo $home->getAdresse();?>" > 
							</div> 
							

								<div class="form-group"> 
							    <label for="exampleInputName2">Image</label> <input type="file" class="form-control" name="image" value="<?php echo $home->getImage();?>"> 
							</div>
