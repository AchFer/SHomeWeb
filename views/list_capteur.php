		...
		<div class="sticky-header header-section ">
			...
			<div class="header-right">
				...
				<div class="search-box">
					<form class="input" action="?core=node&action=search_sensor" method="post">
					...
					<div class="bs-example widget-shadow" data-example-id="contextual-table"> 
						...
						<table class="table">
						    ...
						    {   ?>
						        ...
						        <td><?php echo $capteur->getNomCapteur(); ?></td>
						        <td><?php echo $capteur->getReference(); ?></td>
						        <td>
						        <a class="btn btn-danger" href="?core=node&action=delete_capteur&idCap=<?php echo $capteur->getIdCap(); ?>">  delete </a>
